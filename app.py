...
st.markdown(
    """
    ## 🚀 Supply Chain Performance Highlights  
    ### 📊 Key Achievements:  
    - **📈 15% Revenue Growth:** Optimized supply chain processes have driven a significant revenue increase.  
    - **⏳ 20% Faster Lead Times:** Improved logistics and route planning have cut down delays.  
    - **💰 10% Cost Reduction:** Smart cost-saving strategies have enhanced overall profitability.  

    ### 🔥 Business Impact:  
    - **✅ Higher Customer Satisfaction:** Faster deliveries lead to happier customers and stronger brand loyalty.  
    - **📦 Optimized Inventory Management:** Better demand forecasting prevents overstocking and stockouts.  
    - **💡 Data-Driven Decision Making:** Actionable insights empower smarter strategic moves for sustainable growth.  
    """,
    unsafe_allow_html=True
)
